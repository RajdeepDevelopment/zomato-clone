      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {restaurants.map((restaurant) => (
          <Card
            ...
            className="group cursor-pointer overflow-hidden border border-gray-100 hover:border-gray-200 rounded-2xl shadow-xs hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-white"
          >
            {/* Image & Overlays */}
            <div className="relative aspect-[4/3] w-full overflow-hidden bg-gray-100">
              ...
              {/* Delivery time badge */}
              <div className="absolute bottom-3 left-3 flex items-center gap-1 bg-black/70 backdrop-blur-md text-white text-xs px-2.5 py-1 rounded-lg font-medium">
              ...
              {restaurant.offers && restaurant.offers.length > 0 && (
                <div className="absolute top-3 left-3 bg-blue-600 text-white text-[11px] font-bold px-2.5 py-1 rounded-lg shadow-md uppercase tracking-wider">
                  {restaurant.offers[0]}
                </div>
              )}
            </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-start justify-between gap-2 mb-1.5">
                ...
                <div className="flex items-center gap-1 bg-emerald-700 text-white text-xs font-bold px-2 py-0.5 rounded-md shrink-0 shadow-xs">
              ...
              <div className="flex items-center justify-between text-sm text-gray-500 mb-3">
                ...
                <span className="font-medium text-gray-700">₹{restaurant.priceForTwo} for two</span>
              </div>
              ...
              <div className="border-t border-gray-100 pt-3 flex items-center justify-between text-xs text-gray-400">
                ...
                {restaurant.tags && restaurant.tags[0] && (
                  <span className="text-zomato font-medium bg-zomato-light px-2 py-0.5 rounded">
                    {restaurant.tags[0]}
                  </span>
                )}
              </div>
